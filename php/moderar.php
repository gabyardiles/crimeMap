<?php
    ...
    foreach ($registros as $crime) {
        ...
        echo "<tr><td><div class='custom-control custom-checkbox'><input type='checkbox' name='crimes[]' class='custom-control-input' id='customCheck1'><label class='custom-control-label' for='customCheck1'></label></div></td><td>$crime->ID_crime</td><td>$crime->type_crime_description</td><td>$crime->crime_description</td><td>$crime->date_crime $crime->hour_crime</td><td>$crime->zone_description</td></tr>";
    }
    exit();